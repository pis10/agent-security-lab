        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_260px] gap-8">
          <article className="min-w-0 space-y-8">
            ...
            <section className="p-card p-5 space-y-4">
              {context && <p className="text-[15px] leading-relaxed whitespace-pre-wrap text-slate-700">{context}</p>}
          ...
          <aside className="lg:sticky lg:top-20 h-fit space-y-3">
            <div className="p-card p-4 space-y-3">
              ...
              <button
                ...
                onClick={() => nav.push(`/observe/${scenario.target}`)}
              >
